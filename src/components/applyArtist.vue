    ...
    <q-card class="card apply" v-if="mode === 'page1'">
      ...
      <q-card-section class="applyArtist-content">
        ...
        <!-- <input
          ...
          -->
        <div class="label">
          <q-input color="brand" square outlined :dense="dense" v-model="defaultArtistEmail ? defaultArtistEmail : artistEmail" :disable="defaultArtistEmail? true : false"  placeholder="邮箱" />
        </div>
...
export default {
  data() {
    return {
      ...
      firstname: "",
      lastname: "",
      defaultArtistEmail: this.$store.state.user.info ? this.$store.state.user.info.email : "",
      artistEmail: "",
      country: "国家",
